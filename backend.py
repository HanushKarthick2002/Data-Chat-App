...
def generate_query(question: str = Form(...)):
    ...
    Write a SQLite query (assuming table name is 'uploaded_data') to answer the question.Always use give column name in brackets [] without altering the origignal column name in case of like stataments
    """
...
def re_generate(
    ...
    Always use give column name in brackets [] without altering the origignal column name in case of like stataments
    """
